...
if(isset($_POST['add_product']))
{
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `books`(name, price, image) VALUES('$name', '$price', '$image')") or die('query failed');
...
<section class="add-products">
   ...
   <h1 class="title"> <span style="color:orange;">&hearts;</span> products <span style="color:orange;">&hearts;</span> </h1>
